import { Catch, ExceptionFilter, Logger, ArgumentsHost, HttpStatus, HttpException, UnauthorizedException } from "@nestjs/common";
...
export class GlobalExceptionFilter implements ExceptionFilter {
  private readonly logger = new Logger(GlobalExceptionFilter.name);
    ...
    this.logger.error(`Exception: ${JSON.stringify(errorResponse)}`, exception instanceof Error ? exception.stack : undefined);
